# payment-service - KubernetesPodPending 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0180-pod_pending-payment-service`
...
`payment-service` 触发 `KubernetesPodPending`，触发条件为：Pod 处于 Pending 状态超过 10 分钟。
