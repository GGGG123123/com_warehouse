# vector-indexer - LogCollectorBacklogHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0245-log_collector_backlog-vector-indexer`
- 数据类型: `aiops_runbook`
...
当用户询问 `vector-indexer` 的 `LogCollectorBacklogHigh`、`日志采集异常`、响应变慢、
