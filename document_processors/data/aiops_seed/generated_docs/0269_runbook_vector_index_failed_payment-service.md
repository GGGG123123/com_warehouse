# payment-service - VectorIndexBuildFailed 运维处置知识

## 元数据

- 文档ID: `AIOPS-0269-vector_index_failed-payment-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `payment-service` 的 `VectorIndexBuildFailed`、`向量库异常`、响应变慢、
