# nginx-ingress - CertificateExpiringSoon 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0292-certificate_expiring-nginx-ingress`
...
`nginx-ingress` 触发 `CertificateExpiringSoon`，触发条件为：TLS 证书将在 14 天内过期。
