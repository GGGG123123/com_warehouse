# user-service - Ingress5xxRateHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0170-ingress_5xx-user-service`
...
`user-service` 触发 `Ingress5xxRateHigh`，触发条件为：Ingress 5xx 比例连续 5 分钟超过 3%。
