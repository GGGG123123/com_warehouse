# order-service - PrometheusScrapeFailure 运维处置知识

## 元数据

- 文档ID: `AIOPS-0223-prometheus_scrape_failure-order-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `order-service` 的 `PrometheusScrapeFailure`、`监控异常`、响应变慢、
