# vector-indexer - VectorIndexBuildFailed 运维处置知识

## 元数据

- 文档ID: `AIOPS-0275-vector_index_failed-vector-indexer`
- 数据类型: `aiops_runbook`
...
当用户询问 `vector-indexer` 的 `VectorIndexBuildFailed`、`向量库异常`、响应变慢、
