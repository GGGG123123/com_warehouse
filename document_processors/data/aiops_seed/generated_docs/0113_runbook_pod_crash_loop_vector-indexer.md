# vector-indexer - KubernetesPodCrashLooping 运维处置知识

## 元数据

- 文档ID: `AIOPS-0113-pod_crash_loop-vector-indexer`
- 数据类型: `aiops_runbook`
...
当用户询问 `vector-indexer` 的 `KubernetesPodCrashLooping`、`容器异常`、响应变慢、
