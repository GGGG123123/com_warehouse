# payment-service - EmbeddingAPIFailureRateHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0255-embedding_api_failure-payment-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `payment-service` 的 `EmbeddingAPIFailureRateHigh`、`AI 服务异常`、响应变慢、
