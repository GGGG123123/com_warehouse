# payment-service - MilvusSearchLatencyHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0143-milvus_search_slow-payment-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `payment-service` 的 `MilvusSearchLatencyHigh`、`向量数据库异常`、响应变慢、
