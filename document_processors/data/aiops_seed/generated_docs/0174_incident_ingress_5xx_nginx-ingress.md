# nginx-ingress - Ingress5xxRateHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0174-ingress_5xx-nginx-ingress`
...
`nginx-ingress` 触发 `Ingress5xxRateHigh`，触发条件为：Ingress 5xx 比例连续 5 分钟超过 3%。
