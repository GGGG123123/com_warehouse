# cls-collector - LogCollectorBacklogHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0249-log_collector_backlog-cls-collector`
- 数据类型: `aiops_runbook`
...
当用户询问 `cls-collector` 的 `LogCollectorBacklogHigh`、`日志采集异常`、响应变慢、
