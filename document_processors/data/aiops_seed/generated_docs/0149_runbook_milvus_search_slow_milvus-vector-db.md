# milvus-vector-db - MilvusSearchLatencyHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0149-milvus_search_slow-milvus-vector-db`
- 数据类型: `aiops_runbook`
...
当用户询问 `milvus-vector-db` 的 `MilvusSearchLatencyHigh`、`向量数据库异常`、响应变慢、
