# embedding-worker - HighErrorRate 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0070-high_error_rate-embedding-worker`
...
`embedding-worker` 触发 `HighErrorRate`，触发条件为：5xx 错误率连续 5 分钟超过 5%。
