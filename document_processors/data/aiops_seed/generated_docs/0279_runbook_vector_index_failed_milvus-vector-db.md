# milvus-vector-db - VectorIndexBuildFailed 运维处置知识

## 元数据

- 文档ID: `AIOPS-0279-vector_index_failed-milvus-vector-db`
- 数据类型: `aiops_runbook`
...
当用户询问 `milvus-vector-db` 的 `VectorIndexBuildFailed`、`向量库异常`、响应变慢、
