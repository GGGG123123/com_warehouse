# embedding-worker - LogCollectorBacklogHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0248-log_collector_backlog-embedding-worker`
...
`embedding-worker` 触发 `LogCollectorBacklogHigh`，触发条件为：日志采集队列积压连续 10 分钟增长。
