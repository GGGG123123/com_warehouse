# kafka-broker - KafkaConsumerLagHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0102-queue_lag-kafka-broker`
...
`kafka-broker` 触发 `KafkaConsumerLagHigh`，触发条件为：消费者 lag 连续 10 分钟增长且超过 10000。
