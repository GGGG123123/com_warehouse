# order-service - CertificateExpiringSoon 运维处置知识

## 元数据

- 文档ID: `AIOPS-0283-certificate_expiring-order-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `order-service` 的 `CertificateExpiringSoon`、`安全与证书`、响应变慢、
