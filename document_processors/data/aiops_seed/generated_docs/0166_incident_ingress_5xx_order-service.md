# order-service - Ingress5xxRateHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0166-ingress_5xx-order-service`
...
`order-service` 触发 `Ingress5xxRateHigh`，触发条件为：Ingress 5xx 比例连续 5 分钟超过 3%。
