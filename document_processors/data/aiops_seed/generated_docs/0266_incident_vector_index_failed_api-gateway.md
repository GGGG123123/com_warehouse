# api-gateway - VectorIndexBuildFailed 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0266-vector_index_failed-api-gateway`
...
`api-gateway` 触发 `VectorIndexBuildFailed`，触发条件为：向量索引构建任务失败或超过 30 分钟未完成。
