# rag-agent - DatabaseSlowQuery 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0082-db_slow_query-rag-agent`
...
`rag-agent` 触发 `DatabaseSlowQuery`，触发条件为：慢查询数量 10 分钟内超过 100 条或单 SQL 超过 1 秒。
