# user-service - MilvusSearchLatencyHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0146-milvus_search_slow-user-service`
...
`user-service` 触发 `MilvusSearchLatencyHigh`，触发条件为：Milvus 向量检索 P95 延迟连续 10 分钟超过 1 秒。
