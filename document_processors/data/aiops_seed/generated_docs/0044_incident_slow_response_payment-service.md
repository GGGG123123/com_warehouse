# payment-service - SlowResponse 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0044-slow_response-payment-service`
...
`payment-service` 触发 `SlowResponse`，触发条件为：P99 响应时间连续 5 分钟超过 3 秒。
