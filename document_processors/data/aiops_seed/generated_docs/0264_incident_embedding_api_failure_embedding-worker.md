# embedding-worker - EmbeddingAPIFailureRateHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0264-embedding_api_failure-embedding-worker`
...
`embedding-worker` 触发 `EmbeddingAPIFailureRateHigh`，触发条件为：Embedding API 调用失败率连续 5 分钟超过 5%。
