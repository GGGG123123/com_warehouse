# order-service - RedisMemoryHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0212-redis_memory_high-order-service`
...
`order-service` 触发 `RedisMemoryHigh`，触发条件为：Redis 内存使用率连续 10 分钟超过 85%。
