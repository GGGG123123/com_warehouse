# api-gateway - KubernetesPodPending 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0176-pod_pending-api-gateway`
...
`api-gateway` 触发 `KubernetesPodPending`，触发条件为：Pod 处于 Pending 状态超过 10 分钟。
