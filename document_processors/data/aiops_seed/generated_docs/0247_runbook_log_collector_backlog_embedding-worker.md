# embedding-worker - LogCollectorBacklogHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0247-log_collector_backlog-embedding-worker`
- 数据类型: `aiops_runbook`
...
当用户询问 `embedding-worker` 的 `LogCollectorBacklogHigh`、`日志采集异常`、响应变慢、
