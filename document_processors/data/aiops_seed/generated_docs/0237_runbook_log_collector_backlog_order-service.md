# order-service - LogCollectorBacklogHigh 运维处置知识

## 元数据

- 文档ID: `AIOPS-0237-log_collector_backlog-order-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `order-service` 的 `LogCollectorBacklogHigh`、`日志采集异常`、响应变慢、
