# vector-indexer - KafkaConsumerLagHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0098-queue_lag-vector-indexer`
...
`vector-indexer` 触发 `KafkaConsumerLagHigh`，触发条件为：消费者 lag 连续 10 分钟增长且超过 10000。
