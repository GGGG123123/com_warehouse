# payment-service - LogCollectorBacklogHigh 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0240-log_collector_backlog-payment-service`
...
`payment-service` 触发 `LogCollectorBacklogHigh`，触发条件为：日志采集队列积压连续 10 分钟增长。
