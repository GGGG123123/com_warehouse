# nginx-ingress - CertificateExpiringSoon 运维处置知识

## 元数据

- 文档ID: `AIOPS-0291-certificate_expiring-nginx-ingress`
- 数据类型: `aiops_runbook`
...
当用户询问 `nginx-ingress` 的 `CertificateExpiringSoon`、`安全与证书`、响应变慢、
