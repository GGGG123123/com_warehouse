# redis-cluster - RedisHitRateLow 故障案例

## 元数据

- 文档ID: `AIOPS-INCIDENT-0096-redis_hit_rate_low-redis-cluster`
...
`redis-cluster` 触发 `RedisHitRateLow`，触发条件为：Redis 命中率连续 10 分钟低于 80%。
