# payment-service - CertificateExpiringSoon 运维处置知识

## 元数据

- 文档ID: `AIOPS-0285-certificate_expiring-payment-service`
- 数据类型: `aiops_runbook`
...
当用户询问 `payment-service` 的 `CertificateExpiringSoon`、`安全与证书`、响应变慢、
